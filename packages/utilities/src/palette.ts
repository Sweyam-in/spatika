/**
 * Default colour palette, from Tailwind CSS v4 (MIT License, Copyright (c) Tailwind Labs, Inc.).
 * See NOTICE.md. Apps should prefer Spatika semantic colours; the palette exists so
 * existing class names (`text-amber-600`) keep rendering exactly as before.
 */
