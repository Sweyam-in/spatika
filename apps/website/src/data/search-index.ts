...
const SYNONYMS: Record<string, string[]> = {
  ...
  "date-picker": ["calendar", "datepicker", "date field"],
  "date-input": ["date field", "birthday", "date of birth", "typed date", "expiry"],
  "time-input": ["time picker", "timepicker", "clock", "hour", "time field", "schedule time"],
